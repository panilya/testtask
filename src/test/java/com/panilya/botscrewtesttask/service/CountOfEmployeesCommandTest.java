...
import com.panilya.botscrewtesttask.service.commands.CountOfEmployeesCommand;
...
@ClearDatabase
@ActiveProfiles("test")
public class CountOfEmployeesCommandTest {

    @Autowired
    private CountOfEmployeesCommand countOfEmployeesCommand;
    ...
    void testCommandExecution() {
        ...
        CommandInformation command = CommandInformation.COUNT_OF_EMPLOYEE_FOR_THE_DEPARTMENT_COMMAND;
        String commandResult = countOfEmployeesCommand.executeCommand(command.getInputTemplate().formatted(mathDepartment.getName()));
        assertThat(commandResult).isEqualTo(command.getOutputTemplate().formatted(2));
    }
